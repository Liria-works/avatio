...
CREATE
OR REPLACE FUNCTION "public"."avatars_order_by_count"() RETURNS "json" LANGUAGE "plpgsql" AS $ $ declare result json;

begin
select
    json_agg(t) into result
from
    (
        select
            setups.avatar,
...
CREATE
OR REPLACE FUNCTION "public"."check_password"("user_id" "uuid", "plain_password" "text") RETURNS boolean LANGUAGE "plpgsql" SECURITY DEFINER AS $ $ DECLARE is_password_correct BOOLEAN;
...
values
    (new.id, substring(md5(random() :: text), 1, 10));
...
CREATE
OR REPLACE FUNCTION "public"."popular_avatars"() RETURNS SETOF "public"."items" LANGUAGE "plpgsql" AS $ $ BEGIN RETURN QUERY
SELECT
    i.*
FROM
    public.setups s
...
CREATE
OR REPLACE FUNCTION "public"."search_items"("keywords" "text") RETURNS TABLE(
    "id" bigint,
    "name" "text",
    "shop_id" "text",
    "shop" "text",
...
CREATE
OR REPLACE FUNCTION "public"."search_setups_item"("query" bigint []) RETURNS TABLE(
    "id" bigint,
    "created_at" timestamp with time zone,
    "updated_at" timestamp with time zone,
    "name" "text",
...
SELECT
    ...
    s.image,
    i.id AS avatar_id,
    i.name AS avatar_name,
    i.thumbnail AS avatar_thumbnail,
    s.avatar_note,
    u.id AS author_id,
...
WHERE
    si.item_id = ANY (query)
    OR query @ > ARRAY [s.avatar]
ORDER BY
    s.created_at DESC;
...
ALTER FUNCTION "public"."search_setups_item"("query" bigint []) OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."search_setups_tag"("query" "text" []) RETURNS TABLE(
    "id" bigint,
    "created_at" timestamp with time zone,
    "updated_at" timestamp with time zone,
    "name" "text",
...
FROM
    ...
    join items i on s.avatar = i.id
    join setup_items si on s.id = si.setup_id
    left join setup_tags st on s.id = st.setup_id -- WHERE
    --   st.tag @> query
ORDER BY
    s.created_at DESC;
...
ALTER FUNCTION "public"."search_setups_tag"("query" "text" []) OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."search_tags"("keywords" "text", "exclude" "text" []) RETURNS TABLE("tag" "text", "score" double precision) LANGUAGE "plpgsql" AS $ $ BEGIN RETURN QUERY
SELECT
    DISTINCT t.tag,
...
CREATE
OR REPLACE FUNCTION "public"."tags_order_by_count"() RETURNS "json" LANGUAGE "plpgsql" AS $ $ declare result json;
...
ALTER TABLE
    "public"."articles" OWNER TO "postgres";
...
ALTER TABLE
    "public"."badges" OWNER TO "postgres";
...
ALTER TABLE
    "public"."bookmarks" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."bookmarks_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."feedback" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."feedback_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."report_setup" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."report_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."report_user" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."report_user_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."setup_items" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."setup_items_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."setup_tags" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."setup_tags_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."setups" OWNER TO "postgres";
...
ADD
    GENERATED BY DEFAULT AS IDENTITY (
        SEQUENCE NAME "public"."setups_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
    );
...
ALTER TABLE
    "public"."shops" OWNER TO "postgres";
...
ALTER TABLE
    ONLY "public"."badges"
ADD
    CONSTRAINT "badges_pkey" PRIMARY KEY ("user_id");
...
ALTER TABLE
    ONLY "public"."report_setup"
ADD
    CONSTRAINT "report_pkey" PRIMARY KEY ("id");

ALTER TABLE
    ONLY "public"."report_user"
ADD
    CONSTRAINT "report_user_pkey" PRIMARY KEY ("id");

ALTER TABLE
    ONLY "public"."setup_items"
ADD
    CONSTRAINT "setup_items_pkey" PRIMARY KEY ("id");

ALTER TABLE
    ONLY "public"."setup_tags"
ADD
    CONSTRAINT "setup_tags_pkey" PRIMARY KEY ("id");

ALTER TABLE
    ONLY "public"."setups"
ADD
    CONSTRAINT "setups_id_key" UNIQUE ("id");
...
UPDATE
    ON "public"."items" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');

CREATE
OR REPLACE TRIGGER "handle_updated_at_shops" BEFORE
UPDATE
    ON "public"."shops" FOR EACH ROW EXECUTE FUNCTION "public"."moddatetime"('updated_at');

CREATE
OR REPLACE TRIGGER "vercel-deploy"
AFTER
INSERT
    OR DELETE
    OR
UPDATE
    ON "public"."articles" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"(
        'https://api.vercel.com/v1/integrations/deploy/prj_QpcYQLzkTBemcNIDs4HRWne4ecbW/0vU2dp1jK5',
        'POST',
...
ALTER TABLE
    ONLY "public"."badges"
ADD
    CONSTRAINT "badges_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."bookmarks"
ADD
    CONSTRAINT "bookmarks_post_fkey" FOREIGN KEY ("post") REFERENCES "public"."setups"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."bookmarks"
ADD
    CONSTRAINT "bookmarks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."feedback"
ADD
    CONSTRAINT "feedback_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."users"("id") ON UPDATE CASCADE;

ALTER TABLE
    ONLY "public"."items"
ADD
    CONSTRAINT "items_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON UPDATE CASCADE;

ALTER TABLE
    ONLY "public"."report_setup"
ADD
    CONSTRAINT "report_setup_id_fkey" FOREIGN KEY ("setup_id") REFERENCES "public"."setups"("id") ON UPDATE CASCADE;

ALTER TABLE
    ONLY "public"."report_setup"
ADD
    CONSTRAINT "report_setup_reporter_fkey" FOREIGN KEY ("reporter") REFERENCES "public"."users"("id");

ALTER TABLE
    ONLY "public"."report_user"
ADD
    CONSTRAINT "report_user_reportee_fkey" FOREIGN KEY ("reportee") REFERENCES "public"."users"("id");

ALTER TABLE
    ONLY "public"."report_user"
ADD
    CONSTRAINT "report_user_reporter_fkey" FOREIGN KEY ("reporter") REFERENCES "public"."users"("id");

ALTER TABLE
    ONLY "public"."report_user"
ADD
    CONSTRAINT "report_user_user_id_fkey" FOREIGN KEY ("reportee") REFERENCES "public"."users"("id") ON UPDATE CASCADE;

ALTER TABLE
    ONLY "public"."setup_items"
ADD
    CONSTRAINT "setup_items_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON UPDATE CASCADE;

ALTER TABLE
    ONLY "public"."setup_items"
ADD
    CONSTRAINT "setup_items_setup_id_fkey" FOREIGN KEY ("setup_id") REFERENCES "public"."setups"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."setup_tags"
ADD
    CONSTRAINT "setup_tags_setup_id_fkey" FOREIGN KEY ("setup_id") REFERENCES "public"."setups"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."setups"
ADD
    CONSTRAINT "setups_author_fkey" FOREIGN KEY ("author") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE
    ONLY "public"."setups"
ADD
    CONSTRAINT "setups_avatar_fkey" FOREIGN KEY ("avatar") REFERENCES "public"."items"("id") ON UPDATE CASCADE ON DELETE
SET
    NULL;
...
CREATE POLICY "Allow update for users themselves." ON "public"."users" FOR
UPDATE
    USING (
        (
            (
...
CREATE POLICY "Enable delete for users based on author" ON "public"."setups" FOR DELETE TO "authenticated" USING (
    (
        (
            SELECT
                "auth"."uid"() AS "uid"
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."bookmarks" FOR DELETE TO "authenticated" USING (
    (
        (
            SELECT
                "auth"."uid"() AS "uid"
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."bookmarks" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."feedback" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."report_setup" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."report_user" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."setup_items" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."setup_tags" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."setups" FOR
INSERT
    TO "authenticated" WITH CHECK (true);

CREATE POLICY "Enable read access for all users" ON "public"."articles" FOR
SELECT
    USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."badges" FOR
SELECT
    USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."bookmarks" FOR
SELECT
...
CREATE POLICY "Enable read access for all users" ON "public"."setup_items" FOR
SELECT
    USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."setup_tags" FOR
SELECT
    USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."setups" FOR
SELECT
    USING (true);
...
ALTER TABLE
    "public"."articles" ENABLE ROW LEVEL SECURITY;

ALTER TABLE
    "public"."badges" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE
    "public"."report_setup" ENABLE ROW LEVEL SECURITY;

ALTER TABLE
    "public"."report_user" ENABLE ROW LEVEL SECURITY;

ALTER TABLE
    "public"."setup_items" ENABLE ROW LEVEL SECURITY;

ALTER TABLE
    "public"."setup_tags" ENABLE ROW LEVEL SECURITY;

ALTER TABLE
    "public"."setups" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."search_setups_item"("query" bigint []) TO "anon";

GRANT ALL ON FUNCTION "public"."search_setups_item"("query" bigint []) TO "authenticated";

GRANT ALL ON FUNCTION "public"."search_setups_item"("query" bigint []) TO "service_role";

GRANT ALL ON FUNCTION "public"."search_setups_tag"("query" "text" []) TO "anon";

GRANT ALL ON FUNCTION "public"."search_setups_tag"("query" "text" []) TO "authenticated";

GRANT ALL ON FUNCTION "public"."search_setups_tag"("query" "text" []) TO "service_role";
