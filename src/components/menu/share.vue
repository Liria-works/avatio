    ...
    <div>
        <Menu as="div" class="relative inline-block text-left">
            <div>
                <Tooltip :text="props.triggerTooltip">
                    <MenuButton
                        ...
                        <p class="empty:hidden whitespace-nowrap">{{ props.triggerLabel }}</p>
                    </MenuButton>
                </Tooltip>
            </div>
            ...
            <transition enter-active-class="transition duration-100 ease-out"
                ...
                <MenuItems
                    class="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-xl bg-white dark:bg-black shadow-lg">
                    <div class="p-2">
                        <MenuItem v-slot="{ active }">
                        <a :href="`http://twitter.com/share?url=${props.link}&hashtags=avatio`" target="_blank" :class="[
                            active ? 'bg-neutral-700 text-neutral-100' : 'text-neutral-100',
                            'group flex w-full items-center rounded-lg px-2 py-2 text-sm',
                        ]">
                            <Icon :active="active" icon="simple-icons:x" class="mr-2 h-5 w-5 text-neutral-300" />
                            ポスト
                        </a>
                        </MenuItem>
                        ...
                        <button :class="[
                            ...
                            <Icon :active="active" icon="lucide:link" class="mr-2 h-5 w-5 text-neutral-300" />
                            リンクをコピー
                        </button>
                        </MenuItem>
                    </div>
