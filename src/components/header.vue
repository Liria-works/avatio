...
<template>
    <div class="flex items-start justify-between w-full">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-shrink-0">
            <img width="160" src="/logo_2_light.svg" alt="Avatio Logo" />
        ...
        <div class="flex items-center gap-12 inset">
            <div class="items-center gap-2 flex">
                <div class="items-center gap-0.5 flex">
                    <AButton :icon-size="20" icon="i-heroicons-magnifying-glass-20-solid" tooltip="検索"
                    ...
                    <ClientOnly>
                        <AButton :icon-size="20" icon="i-heroicons-sun-20-solid" />
                        <template #fallback>
                            <div class="w-0 h-8" />
                        </template>
                    </ClientOnly>
                    ...
                    <UPopover :ui="{
                        ...
                        <AButton :icon-size="20" icon="lucide:languages" tooltip="Languages" />
                ...
                <div class="flex">
                    <NuxtLink to="/login">
                        <AButton v-if="!user" icon="lucide:log-in" tooltip="ログイン" />
                    </NuxtLink>
